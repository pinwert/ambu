  ...
  function In(t, e, a) {
              ...
              t > 0 &&
                ...
                On &&
                  P("mouseenter", o, function () {
                    Un.locked || Gt(j.indexOf(n), { focus: !0 }, pe.setSeries);
                  })),
              gn)) {
                var u = F("td", null, r);
      ...
      if (Xt) Qt = !0;
        ...
        if (
          ...
          for (var o = 0; j.length > o; o++)
            if (
              (o > 0 && ((Ut[o] = 1 / 0), qn.length > 1 && _(qn[o], -10, -10)),
              bn)
            ) {
              if (0 == o && Rn) continue;
          ...
          t = qt(Yt);
          for (var f = g(_n(e[0][t], J[$n], rt, 0)), c = 0; j.length > c; c++) {
            var v = j[c];
            if (c > 0 && v.show) {
              var h = e[c][t],
    ...
    function le(n, t, e, r, o, i) {
      (null == n || Ln(n)) &&
        ...
        null != n &&
          (P("mouseup", E, ue), ge.pub("mousedown", s, kt, St, rt, ot, null)));
    }
